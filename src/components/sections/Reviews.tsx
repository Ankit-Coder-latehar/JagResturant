...
const testimonialsData: Testimonial[] = [
  {
    ...
    quoteEN: "Jashan Restaurant is a revelation. The Shah Plov is simply a masterwork. Saffron infusion combined with the crunchy flatbread crust creates absolute poetry on the palate.",
    quoteAR: "مطعم جاشان هو اكتشاف حقيقي. طبق شاه بلوف هو تحفة فنية ببساطة. مزيج الزعفران والخبز المقرمش يخلق شعراً حقيقياً في الفم.",
    quoteTR: "Jashan Restaurant tam bir keşif. Şah Pilavı tek kelimeyle bir şaheser. Safran aroması ve çıtır çıtır lavaş kabuğu damakta adeta bir lezzet şiiri yaratıyor.",
    rating: 5,
